...
public class FindLeadPage extends ProjectSpecificMethods {
	...
	public FindLeadPage typePhoneNum(String phNum){
	...
	public ViewLeadPage selectFirstLead() throws InterruptedException {
		Thread.sleep(3000);
		driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a")).click();
		return new ViewLeadPage();
	}
	
	public ViewLeadPage getLeadID() throws InterruptedException {
		Thread.sleep(3000);
